...
# $ ./equations.pl 'a+b++c=d*e, c=f+g,d,g=78,a=1,b=1,e=1,f=1'
# Use of uninitialized value in string eq at graph.pm line 57.
# Use of uninitialized value in string eq at graph.pm line 61.
# Can't use an undefined value as a HASH reference at finding_things.pm line 116.
# london@archlinux:~/perl/scripts/equations/module
# $ ./equations.pl 'a+b--c=d*e, c=f+g,d,g=78,a=1,b=1,e=1,f=1'
# Use of uninitialized value in string eq at graph.pm line 57.
# Use of uninitialized value in string eq at graph.pm line 61.
...
# 	print "NO MATCH";
# }
# if (my @ids=tree_match($solution->{trees}->{right_side}, $tree_pattern)) {
# 	print "MATCH";
# 	print @ids;
# 	print Dumper $solution->{trees};
# 	print Dumper $solution->{nodes}->{$_} foreach @ids;
# }
# else {
# 	print "NO MATCH";
# }
