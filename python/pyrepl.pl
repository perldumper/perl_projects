...
# for implementing -ne -pe --> make a class ???
# put _main_loop upper case

# save program into a file if length of program string is superior of some maximum allowed (which ?)

## BUG

# too much spaces between "try" and ":"

# london@archlinux:~
# $ pyrepl debug -e 'array=list(range(5)); try {print(array[5])}'
# Traceback (most recent call last):
#   File "<string>", line 1, in <module>
#   File "<string>", line 6
# 
...
# london@archlinux:~
# $ pyrepl -e 'print(print("hello"))'
# hello
# None
# london@archlinux:~
# $ pyrepl -e 'var=print("hello")'
# hello
# london@archlinux:~
# $ pyrepl -e 'var=print("hello"); print(var)'
# hello
# None
# london@archlinux:~
# $
...
# london@archlinux:~
# $ pyrepl debug -e 'BEGIN { print("start"); print("start2") } END { print("end"); } print("hello");' wd
# start
# start2
# hello
# end
# ----------------------------------------
# WHITESPACE EQUIVALENT
# print("start"); print("start2")
# print("hello")
# 
# print("end"); ----------------------------------------
# COMMAND
# python -c 'exec("print(\"start\"); print(\"start2\") \nprint(\"hello\")\n\nprint(\"end\"); ")'
# london@archlinux:~
# $
...
if (@BEGIN) {
# 	put them in the order of the array (queue)
}
...
# 			print "INSIDE END {}\n";
# 			print SCRIPT_FILE " " x ($indent_level * $indent_size) . $line . " :\n";
# 			push @END, correctly_whitespaced(get_block());
			push @END, get_block();
# 			get_block();
# 			$indent_level++;
			$line = "";
...
if (@END) {
# 	put them in the reverse order of the array (stack)
}
